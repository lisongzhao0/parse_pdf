...
public class GeneSiteDetectionProcessor {
    ...
    public static void main(String[] args) {
        ...
        String[]  result = new String[]{
                        "[rs4073][AA][0.972][风险][1.01][19.3]\n" + //[等级标准：0-0.8；0.8-1.25；1.25-1.5；1.5以上][19.3][N/A]
                        "[rs1800875][TT][0.036][风险][2.55][19.3]\n" +
                        "[rs1800795][CC][0.585][正常][0.81][18.4]\n" +
                        "[rs4143094][TG][0.532][正常][0.77][18.4]\n" +
                        "[rs4779584][TC][0.113][正常][0.58][22.2]\n" +
                        "[rs6983267][TT][0.53][风险][1.27][22.2]\n" +
                        "[rs75789129][AA][0.125][风险][1.28][4.1]\n" +
                        "[K483Stop][ID][0.544][风险][1.2][4.1]\n" +
                        "[rs213950][AA][0.087][正常][0.7843694003378281][11.7]\n" +
                        "[rs1800872][GG][0.171][风险][1.2965258293875732][11.7]\n"
        };
        ...
        processor.setDetection(arrayDSP[3]);
    ...
    public static class Formula {
        ...
        private void    fillLogicCells(List<LogicCell> logicCells, GroupIndex groupIndex, Object[][]dsp) {
            ...
            for (LogicCell lc : logicCells) {
                ...
                if (rowIdx>=groupIndex.start && rowIdx<=groupIndex.end) {
