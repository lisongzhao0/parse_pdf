...
public class ReadYuanMengProductErTong {

    public static void main(String[] args) {
        OfficeFileUtil officeFile = OfficeFileUtil.newInstance();

        Workbook workbook = officeFile.getExcel("/Users/zhaolisong/Downloads/远盟理化2018年升级基因产品/LHA003儿童营养计算对照表.xlsx");
        ...
        for (int i = 0; i < sheetSize; i ++) {
            ...
            for (int r = 0; r < cells.length; r ++) {
                ...
                for (int c = 0; c < cells[0].length; c ++) {
                    ...
                    if (null!=cells[r][c] && c==4) { col5 = (String)cells[r][c].toString(); }
                    if (null==val) {
                        val = rowPreCopy[c];
                    }
