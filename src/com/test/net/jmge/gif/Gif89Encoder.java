...
import com.test.net.jmge.gif.IndexGif89Frame;
import com.test.net.jmge.gif.Put;
 ...
 * @see com.test.net.jmge.gif.Gif89Frame
...
public class Gif89Encoder {
   ...
   * <blockquote>java Gif89Encoder {filename}</blockquote>
