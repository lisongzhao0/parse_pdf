 ...
 * <br/>For the full spec on Code 128, see {@link http://www.barcodeisland.com/code128.phtml}
 * <p/>Due to the age of this project, the is Java 1.4 compliant
 *
 * @author Glen Edmonds
 * @since 0.2.0
 */
public class Code128Encoder implements BarcodeEncoder {
     ...
     * @see BarcodeEncoder#computeCheckSum(String)
     */
    ...
    /**
     * @param b a byte
     * @return <code>true</code> if the specified byte is a numeric digit character
     */
    ...
    /**
     * @see BarcodeEncoder#encode(String)
     */
