...
public class JBarcodeComponent extends JComponent implements PropertyChangeListener{
    ...
    /* (non-Javadoc)
     * @see JBarcode#setEncoder(encode.BarcodeEncoder)
     */
    ...
    /* (non-Javadoc)
     * @see JBarcode#setNarrowWidth(int)
     */
    ...
    /* (non-Javadoc)
     * @see JBarcode#setPainter(paint.BarcodePainter)
     */
    ...
    /* (non-Javadoc)
     * @see JBarcode#setWideToNarrow(int)
     */
    ...
    /* (non-Javadoc)
     * @see JBarcode#setCheckDigit(boolean)
     */
    ...
    /* (non-Javadoc)
     * @see JBarcode#setShowCheckDigit(boolean)
     */
    ...
    /* (non-Javadoc)
     * @see JBarcode#setShowText(boolean)
     */
    ...
    /* (non-Javadoc)
     * @see JBarcode#setTextPainter(paint.TextPainter)
     */
