...
public class AreaDef extends AbstractDef implements IBound, IXml<AreaDef>, IVariable, IPosition<AreaDef> {
    ...
    public AreaDef parseElement(Element element) {
        ...
        newDef.setCatalog(element.attributeValue("catalog"));
        newDef.setVisible(getStringUtil().isEmpty(element.attributeValue("visible")) ? "true" : element.attributeValue("visible"));
